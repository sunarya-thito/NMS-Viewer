...
public class BlockNylium extends Block implements IBlockFragilePlantElement {
    ...
    public void a(WorldServer worldserver, Random random, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        if (iblockdata1.a(Blocks.CRIMSON_NYLIUM)) {
            WorldGenFeatureNetherForestVegetation.a(worldserver, random, blockposition1, BiomeDecoratorGroups.a.CRIMSON_FOREST_CONFIG, 3, 1);
        } else if (iblockdata1.a(Blocks.WARPED_NYLIUM)) {
            WorldGenFeatureNetherForestVegetation.a(worldserver, random, blockposition1, BiomeDecoratorGroups.a.WARPED_FOREST_CONFIG, 3, 1);
            WorldGenFeatureNetherForestVegetation.a(worldserver, random, blockposition1, BiomeDecoratorGroups.a.NETHER_SPROUTS_CONFIG, 3, 1);
