...
public class BlockVine extends Block {
                ...
                if (enumdirection == EnumDirection.UP && blockposition.getY() < worldserver.getMaxBuildHeight() - 1) {
                    ...
                    if (worldserver.isEmptyBlock(blockposition1)) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (random.nextBoolean() || !isAcceptableNeighbour(worldserver, blockposition1.relative(enumdirection1), enumdirection1)) {
    ...
    private IBlockData copyRandomFaces(IBlockData iblockdata, IBlockData iblockdata1, Random random) {
        Iterator iterator = EnumDirection.EnumDirectionLimit.HORIZONTAL.iterator();
