...
public interface ChangeOverTimeBlock<T extends Enum<T>> {
    ...
    default void onRandomTick(IBlockData iblockdata, WorldServer worldserver, BlockPosition blockposition, Random random) {
        float f = 0.05688889F;

        if (random.nextFloat() < 0.05688889F) {
            this.applyChangeOverTime(iblockdata, worldserver, blockposition, random);
        }
    ...
    default void applyChangeOverTime(IBlockData iblockdata, WorldServer worldserver, BlockPosition blockposition, Random random) {
