...
public class DefinedStructureInfo {
    ...
    public Random getRandom(@Nullable BlockPosition blockposition) {
        return this.random != null ? this.random : (blockposition == null ? new Random(SystemUtils.getMillis()) : new Random(MathHelper.getSeed(blockposition)));
    }
